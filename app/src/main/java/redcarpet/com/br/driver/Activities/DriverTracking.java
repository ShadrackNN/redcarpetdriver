...
import redcarpet.com.br.driver.Helpers.DirectionJSONParser;
...
import redcarpet.com.br.driver.Model.History;
import redcarpet.com.br.driver.Model.Notification;
...
public class DriverTracking extends AppCompatActivity implements OnMapReadyCallback , GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.place_autocomplete_fragment);
