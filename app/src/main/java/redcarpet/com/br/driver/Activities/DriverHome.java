...
import redcarpet.com.br.driver.Interfaces.locationListener;
import redcarpet.com.br.driver.Messages.Errors;
import redcarpet.com.br.driver.Messages.Message;
import redcarpet.com.br.driver.Model.Token;
import redcarpet.com.br.driver.Model.User;
import redcarpet.com.br.driver.R;
import redcarpet.com.br.driver.Util.Location;
...
public class DriverHome extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (CheckInternet.isNetwork(DriverHome.this)) {
            new AlertDialog.Builder(this)
                    .setTitle("Internet Check")
                    .setMessage("You are now ready to get connected. GO LIVE. However, if the application stops, your data may have been exhausted.")
                    .setPositiveButton("Ok", null)
                    .show();
        }else{
            new AlertDialog.Builder(this)
                    .setTitle("Internet Check")
                    .setMessage("You have no internet connection.Turn on your data or Connect to a WIFI to continue.")
                    .setPositiveButton("Ok", null)
                    .show();
        }
